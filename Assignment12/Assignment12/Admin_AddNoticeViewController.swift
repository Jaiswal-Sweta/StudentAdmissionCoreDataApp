...
class Admin_AddNoticeViewController: UIViewController {
    ...
    private let nameTextField: UITextField = {
        ...
        textField.attributedPlaceholder =
            NSAttributedString(string: "Enter Title", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
    ...
    override func viewDidLoad() {
        ...
        if let n = notice
        {
            ...
            {
                if String(n.sclass!) == ClassArray[i]
                {
            ...
            //set date picker
            DatePicker.setDate(n.noticeDate!, animated: true)
    ...
    override func viewDidLayoutSubviews() {
        ...
        NameLabel.frame = CGRect(x: 15, y: 120, width: 100, height: 30)
...
extension Admin_AddNoticeViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        print("Class of Student = ",ClassOfStudent!)
...
extension Admin_AddNoticeViewController {
    ...
    @objc func OnAddNoticeClicked()
    {
        ...
        if let n = notice
        {
            CoreDataHandler.shared.updateNotice(n: n, noticeTitle: Title, noticeDate: D, noticeDescription: desc,sclass: Class) {
        ...
        {
            CoreDataHandler.shared.insertNotice(noticeTitle: Title, noticeDate: D, noticeDescription: desc,sclass: Class) {
