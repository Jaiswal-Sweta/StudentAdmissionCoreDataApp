//
//  Admin_DashboardViewController.swift
//  Assignment11
//
...
class Admin_DashboardViewController: UIViewController {
    ...
    private let StudentInfoImageView:UIImageView = {
        ...
        imgview.image = UIImage(named: "students_dp")
    ...
    @objc func tapDetectedOnStudent() {
        ...
        let vc = Admin_StudentListViewController()
